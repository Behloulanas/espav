            ...
            <div>
                <div class="container my-5">
                    <form id="contact-form" method="POST"
                        action="https://formsubmit.co/communication.espavkech@gmail.com">
                        <input type="text" id="fname" required placeholder="Nom *" name="nom">

                        <input type="text" id="lname" required placeholder="Prénom" name="prenom">

                        <input type="text" id="email" required placeholder="Votre Email *" name="email">
                        <input type="tel" id="phone" required placeholder="Numéro de téléphone" name="telephone">

                        <input type="text" id="msg" required style="padding: 70px;" placeholder="Votre Message"
                            name="message">
