...
@section('content')
 ...
 <header>
    ...
    <section class="headingg">
        <span class="text1">Making off</span>
    ...
    <div class="wrapper">
        <div class="card">
            <div class="info">
                <h1>Making off News</h1>
 
                <p>كواليس وأجواء ربورتاج إخباري</p>
                <a href="https://www.youtube.com/watch?v=FqSFG4bbzng&list=PLFSJPRVc6NT0YMWFJBPpGPvUa-8kJDIQM&ab_channel=ESPAV"
        ...
        <div class="card">
            <div class="info">
                ...
                <p> le réalisateur Mickael ROYER</p>
                <a href="https://www.youtube.com/watch?v=TyN-AfFhALQ&list=PLFSJPRVc6NT0YMWFJBPpGPvUa-8kJDIQM&index=2&ab_channel=ESPAV"
                    class="btn">Voir video</a>
            </div>
        </div>
    </div>
