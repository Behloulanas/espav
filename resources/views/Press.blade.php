...
<div class="btn">
    ...
    <section class="press">
        <div class="row-press-header">
            ...
            <a href="./index.html" class="acceuil text-cente">Acceuil <span class="text-center"> > Formation
                </span> </a>
    ...
    <section class="press1">
        ...
        <div class="index-post">
            ...
            <div class="main-items">
                <ul class="list-items">
                    <li>
                        <a href="#"><svg xmlns="http://www.w3.org/2000/svg" width="10" height="10" fill="currentColor"
