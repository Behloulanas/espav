...
<div class="btn">
    ...
    <section class="form">
        <div class="row-form-header">
            ...
            <a href="./index.html" class="acceuil text-cente">Acceuil <span class="text-center"> > ESPAV FORMATIONS </span> </a>
    ...
    <section class="form1">
        <div class="row-form-side-bar flex-item">
            <button class="btnn"><a href="./inscription.html"> <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
